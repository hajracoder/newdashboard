...
// Import icons
import {
  Car, Sun, Trees, Snowflake, Music, Mic,
  Tv, Wifi, Bed, Bath, Coffee, Utensils,
  Laptop, Phone, Camera, Book, Heart,
  Gift, Gamepad, Dumbbell, Check, Cake
} from "lucide-react";

// Map icon string => React component
const ICONS_MAP = {
  Car, Sun, Trees, Snowflake, Music, Mic,
  Tv, Wifi, Bed, Bath, Coffee, Utensils,
  Laptop, Phone, Camera, Book, Heart,
...
export default function AttributesPage() {
  ...
  // Save attributes to localStorage on change
  useEffect(() => {
                ...
                <CommandGroup heading="Icons">
                  {ICONS.map((ic, i) => {
                    ...
                    return (
                      <CommandItem
                        key={i}
                        onSelect={() => setSelectedIcon(ic.name as keyof typeof ICONS_MAP)}
