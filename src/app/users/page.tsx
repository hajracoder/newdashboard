...
//   } else {
//     setUsers(dummyUsers)  // yaha dummy data
//   }
//   setMounted(true)
// }, [])
...
export default function UserManagementPage() {
  ...
  const openEditModal = (index: number) => {
    toast(`Edit user: ${users[index].name}`)
  }
    ...
    <div className="p-6 bg-white rounded-lg">
      ...
      <div className="flex items-center py-4 gap-2">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline">
              {roleFilter || "All Roles"} <ChevronsUpDown className="ml-2 h-4 w-4" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end">
            <DropdownMenuItem onClick={() => setRoleFilter("")}>All</DropdownMenuItem>
                  ...
                  <TableRow key={i}>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => askConfirmation("Edit this user?", () => openEditModal(i))}>
                            <Edit className="w-4 h-4 mr-2" /> Edit
                          </DropdownMenuItem>
                          <DropdownMenuItem className="text-red-500" onClick={() => askConfirmation("Delete this user?", () => handleDelete(i))}>
                            <Trash2 className="w-4 h-4 mr-2" /> Delete
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
